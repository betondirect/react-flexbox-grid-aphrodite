...
function getClassNames(props) {
  ...
  return !props.className ? _aphrodite.css.apply(undefined, _toConsumableArray(classes)) : props.className + ' ' + _aphrodite.css.apply(undefined, _toConsumableArray(classes));
}
